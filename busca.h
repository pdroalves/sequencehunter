...
void set_grafo_helper(char *senso,char *antisenso,short int **d_matrix_senso,short int **d_matrix_antisenso);
...
void k_busca(const int loaded,const int seqSize_an,const int seqSize_bu,int bloco1,int bloco2,int blocoV,char **data,short int *resultados,short int *gap,short int **d_matrix_senso,short int **d_matrix_antisenso,cudaStream_t stream1);
