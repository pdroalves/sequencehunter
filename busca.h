...
void k_busca(const int loaded,const int seqSize_an,const int seqSize_bu,int bloco1,int bloco2,int blocoV,char **data,short int *resultados,char **founded,short int **d_matrix_senso,short int **d_matrix_antisenso,cudaStream_t stream);
