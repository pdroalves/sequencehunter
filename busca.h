...
void k_busca(const int loaded,const int seqSize_an,const int seqSize_bu,char **data,int *resultados,char **founded,int **d_matrix_senso,int **d_matrix_antisenso,cudaStream_t stream);
