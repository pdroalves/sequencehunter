...
void k_busca(const int loaded,const int seqSize_an,const int seqSize_bu,int bloco1,int bloco2,int blocoV,char **data,short int *resultados,char **founded,cudaStream_t stream);
...
void cudaCopyCharArrays(char **src,char **dst,int n);void setup_for_cuda(char *seq);
