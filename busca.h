...
void set_grafo_helper(char *senso,char *antisenso,struct vertice_grafo *a,struct vertice_grafo *c,struct vertice_grafo *g, struct vertice_grafo *t);
...
void k_busca(int loaded,int num_blocks,int num_threads,const int bloco1,const int bloco2,const int blocos,char **data,int *resultados,struct vertice_grafo *d_a,struct vertice_grafo *d_c,struct vertice_grafo *d_g,struct vertice_grafo *d_t,cudaStream_t stream);
