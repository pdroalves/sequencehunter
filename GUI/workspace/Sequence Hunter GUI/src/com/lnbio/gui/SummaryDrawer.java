...
public class SummaryDrawer implements ActionListener,Observer {
	...
	public SummaryDrawer(Drawer d,Hunter hunterInstance){
		...
		fullSequenceStrategy = new JLabel(tm.getText("wontStoreFullSequence"));
		CLinhaStrategy = new JLabel(tm.getText("wontStoreCincoLSequences"));
	...
	private void drawSummaryContainer(){
		...
		vbox.add(fullSequenceStrategy);
		vbox.add(CLinhaStrategy);
		c.fill = GridBagConstraints.HORIZONTAL;
		c.weighty = 0.05;
		c.weightx = 1;
		c.gridx = 1;
	...
	public static void setStoreFullSequence(boolean b){
		...
		if(b){
			...
			fullSequenceStrategy.setText(tm.getText("wontStoreFullSequence"));			
		}
	}
