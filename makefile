...
$(OBJ)shunter-cmd.o:$(SOURCE)shunter-cmd.c
	$(CC) -g -c $(SOURCE)shunter-cmd.c -o $(OBJ)shunter-cmd.o $(GLIB_CFLAGS) $(CUDA)
	
$(OBJ)go_hunter.o:$(SOURCE)Go_Hunter/go_hunter.c
	$(CC) -g -c $(SOURCE)Go_Hunter/go_hunter.c -o $(OBJ)go_hunter.o $(GLIB_CFLAGS) $(OPENMP) $(CUDA)
	
$(OBJ)go_hunter_cuda.o:$(SOURCE)Go_Hunter/go_hunter_cuda.c
	$(CC) -g -c $(SOURCE)Go_Hunter/go_hunter_cuda.c -o $(OBJ)go_hunter_cuda.o $(GLIB_CFLAGS) $(OPENMP) $(CUDA)
	
$(OBJ)go_hunter_noncuda.o:$(SOURCE)Go_Hunter/go_hunter_noncuda.c
	$(CC) -g -c $(SOURCE)Go_Hunter/go_hunter_noncuda.c -o $(OBJ)go_hunter_noncuda.o $(GLIB_CFLAGS) $(OPENMP) $(CUDA)
	
$(OBJ)load_data.o:$(SOURCE)External/load_data.c
	$(CC) -g -c $(SOURCE)External/load_data.c -o $(OBJ)load_data.o $(GLIB_CFLAGS)  $(CUDA)
	
$(OBJ)hashtable.o:$(SOURCE)External/hashtable.c
	$(CC) -g -c $(SOURCE)External/hashtable.c -o $(OBJ)hashtable.o $(GLIB_CFLAGS) $(GIO_CFLAGS) $(CUDA) $(OPTIMIZATION)
...
$(OBJ)database.o:$(SOURCE)Processing/database.c
	$(CC) -g -c $(SOURCE)Processing/database.c -o $(OBJ)database.o $(SQLITE3) $(CUDA) $(OPENMP) $(OPTIMIZATION)
